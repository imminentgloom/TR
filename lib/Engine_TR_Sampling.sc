// CroneEngine_TR_Sampling
Engine_TR_Sampling : CroneEngine {
    ...
    *new { arg context, doneCallback;
    ...
    alloc {
        ...
        //////// 3 ////////
		// create the the sound "synth", we'll create four instances of the synth
		// so four samples can be played simultaneously
        synthSampler = Array.fill(4,{arg i;
    ...
    free {
        ...
        4.do({arg i; synthSampler[i].free});
    }
}
